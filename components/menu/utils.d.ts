...
export declare const collectItemKeys: (children: ReactNode, subItemKeys: any[]) => void;
export declare const renderChildren: (fatherKey: string, children: ReactNode, extraProps: extraProps) => any[];
